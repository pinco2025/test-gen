...
const QuestionEditor: React.FC<QuestionEditorProps> = ({ question, solution, onSave, onIntermediateSave, onCancel, onNext, onPrevious, subject, questionNumber, onError }) => {
    ...
    // Use a ref to hold the latest callback to avoid dependency array issues
    const onIntermediateSaveRef = React.useRef(onIntermediateSave);
    React.useEffect(() => {
        onIntermediateSaveRef.current = onIntermediateSave;
    }, [onIntermediateSave]);
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className={`flex-1 p-2 rounded-lg border flex items-center justify-center gap-2 transition-all ${editedQuestion.verification_level_1 === 'approved'
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 p-2 rounded-lg border flex items-center justify-center gap-2 transition-all ${editedQuestion.verification_level_1 === 'rejected'
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 p-2 rounded-lg border flex items-center justify-center gap-2 transition-all ${!editedQuestion.verification_level_1 || editedQuestion.verification_level_1 === 'pending'
