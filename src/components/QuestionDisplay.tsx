...
export const QuestionDisplay = memo<QuestionDisplayProps>(({
  ...
  // Sync with default prop when it changes (using key prop in parent to force reset is safer, but this is a backup)
  useState(() => {
    setIsSolutionVisible(defaultSolutionExpanded);
  });
