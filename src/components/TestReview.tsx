    ...
    <div className="flex flex-col flex-1 min-h-0 bg-background-light dark:bg-background-dark text-text-main dark:text-text-dark">
      ...
      <footer className="flex items-center justify-between p-4 border-t border-border-light dark:border-border-dark shrink-0">
        ...
        <div className="flex justify-center flex-1 gap-3">
          ...
          <button onClick={() => alert("Coming soon: Replace with inspired question")} className="px-5 py-2.5 rounded-lg bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-900/50 text-sm font-semibold transition-all flex items-center gap-2">
            <span className="material-symbols-outlined text-base">autorenew</span> Replace
          </button>
